...
<div class="post-updated" markdown=1>
...
Nextcloud was removed entirely from my stack, not long after using it, because it does not play well with Apple devices and the UI is _very janky_ which is a shame for a project as mature as it is.
