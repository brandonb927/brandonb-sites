...
- [ExpressVPN]({% link r/vpn.md %}) — the only VPN I trust because they [don't retain _any_ logs](https://www.expressvpn.com/what-is-vpn/policy-towards-logs)
...
- Keyboard: [Keychron K2, RGB aluminum frame with brown switches]({% link r/keychron.md %}), {% amazon B00FPDAU6Q "Wrist rest" %}, {% amazon B07N13PW4V "Uncrowned Kings black leather desk pad" %}
